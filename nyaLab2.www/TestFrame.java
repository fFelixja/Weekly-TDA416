...
/* ###### TAG BORT kommentarna på de 2 följande raderna när ni skrivit era samlingar */
	...
	public TestFrame() {
		...
		radioknapparna.setPreferredSize(new Dimension(600,50)); // min size on height
		...
		test.setForeground(Color.black);  // pen Color
		test.setPreferredSize(new Dimension(200,50)); // min size on buttons
		berakna.addActionListener(this);
		berakna.setForeground(Color.black);
